...
from packages.qbr_core.planning.builder import _dedupe_queries, linguistic_plan
...
class QueryPlannerAgent:
    ...
    def __init__(self, model: Any | None = None, *, provider: str | None = None, model_name: str | None = None) -> None:
        """Initialize the query planner agent and its dependencies."""
        self.model = model
    ...
    def plan(
        ...
        *,
        ...
        """Build a typed retrieval and answer plan for the question."""
    ...
    def _planner_prompt(
        ...
        """Build prompt for this query planner agent."""
        history_text = (
