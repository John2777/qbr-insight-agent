...
class ParsedPersistenceService:
    ...
    def persist_parsed(
        ...
        """Persist one complete presentation parse in a single transaction."""
        warnings = [
            *parsed.warnings,
    ...
    def _persist_slide(
        ...
        """Persist one slide and all of its normalized child records."""
    ...
    def _persist_non_chart_elements(
        ...
        """Persist native non-chart elements as evidence records."""
    ...
    def _persist_chart_elements(
        ...
        """Persist chart structure, points, and source elements."""
    ...
    def _chart_source_element(
        ...
        """Select the source element that owns a native chart."""
    ...
    def _persist_notes(self, conn: sqlite3.Connection, job: sqlite3.Row, slide_id: str, slide: ParsedSlide) -> None:
        """Persist speaker notes as searchable evidence chunks."""
        if not slide.notes:
            return
        notes = ParsedElement(
            "notes",
    ...
    def _persist_visual_knowledge(
        ...
        """Persist visual observations as non-authoritative retrieval chunks."""
    ...
    def _normalize_chart_bbox(self, bbox: dict[str, Any] | None, slide: ParsedSlide) -> dict[str, float]:
        """Normalize chart geometry into the slide coordinate system."""
        if not bbox:
    ...
    def _insert_element(self, conn: sqlite3.Connection, slide_id: str, element: ParsedElement) -> str:
        """Insert one normalized slide element and return its identifier."""
    ...
    def _table_text(element: ParsedElement) -> str:
        """Render a parsed table as bounded searchable text."""
    ...
    def _insert_chunk(
        ...
        *,
        ...
        """Insert one provenance-preserving retrieval chunk."""
    ...
    def _insert_chart(
        ...
        *,
        ...
        """Insert a native chart and its normalized data points."""
