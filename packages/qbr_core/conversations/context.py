...
from packages.qbr_core.conversations.summary import SUMMARY_VERSION
...
class ConversationContext:
    """Hold the immutable summary and recent turns used by one answer run."""
    summary: dict[str, Any]
    history: tuple[dict[str, str], ...]
    diagnostics: dict[str, Any]

    def history_list(self) -> list[dict[str, str]]:
        """Return conversation history in prompt-ready dictionary form."""
...
class ConversationContextAssembler:
    ...
    def __init__(self, *, max_turns: int, token_budget: int, summary_token_budget: int = 800) -> None:
        """Initialize the conversation context assembler and its dependencies."""
    ...
    def load_or_create(
        ...
        *,
        ...
        """Load a run context snapshot or create it deterministically."""
    ...
    def _deserialize(
        ...
        """Deserialize a persisted conversation context snapshot."""
    ...
    def _fit_summary_to_budget(summary: Any, budget: int) -> dict[str, Any]:
        """Fit summary to budget for this conversation context assembler."""
