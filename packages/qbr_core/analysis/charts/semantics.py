...
class ChartDataCube:
    ...
    def from_rows(cls, scope_id: str, rows: Iterable[dict[str, Any]]) -> ChartDataCube | None:
        """Build a chart data cube from normalized database rows."""
    ...
    def is_ordered_categorical(self) -> bool:
        """Return whether this chart data cube is ordered categorical."""
    ...
    def analytical_entity_count(self) -> int:
        """Return the analytical entity count for this chart data cube."""
        if len(self.groups) > 1:
    ...
    def is_analyzable(self) -> bool:
        """Return whether this chart data cube is analyzable."""
    ...
    def mentioned_series(self, question: str) -> tuple[str, ...]:
        """Return series names explicitly mentioned in the plan."""
    ...
    def mentioned_categories(self, question: str) -> tuple[str, ...]:
        """Return category names explicitly mentioned in the plan."""
    ...
    def point(self, series: str, category: str) -> dict[str, Any] | None:
        """Return the chart point at a normalized series-category coordinate."""
    ...
    def series_rows(self, series: str) -> tuple[dict[str, Any], ...]:
        """Return source rows along the selected chart-cube axis."""
    ...
    def relevance(self, question: str) -> int:
        """Score cube relevance against the semantic query plan."""
    ...
    def sequential_path(self) -> dict[str, Any] | None:
        """Return ordered points for sequential path analysis."""
